...
1. Checkout both projects SandroProxyLib and SandroProxyPlugin

2. To get jar that can be used in sandroproxy you should build with ant.
...
3. Now you have file in assets dir that can be used in SandroProxy as plugin
