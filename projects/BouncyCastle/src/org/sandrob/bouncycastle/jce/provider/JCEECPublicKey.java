...
import org.sandrob.bouncycastle.asn1.DERBitString;
...
import org.sandrob.bouncycastle.asn1.cryptopro.ECGOST3410NamedCurves;
import org.sandrob.bouncycastle.asn1.cryptopro.GOST3410PublicKeyAlgParameters;
...
import org.sandrob.bouncycastle.asn1.x9.X962Parameters;
import org.sandrob.bouncycastle.asn1.x9.X9ECParameters;
import org.sandrob.bouncycastle.asn1.x9.X9ECPoint;
import org.sandrob.bouncycastle.asn1.x9.X9IntegerConverter;
import org.sandrob.bouncycastle.asn1.x9.X9ObjectIdentifiers;
import org.sandrob.bouncycastle.crypto.params.ECDomainParameters;
import org.sandrob.bouncycastle.crypto.params.ECPublicKeyParameters;
import org.sandrob.bouncycastle.jce.ECGOST3410NamedCurveTable;
import org.sandrob.bouncycastle.jce.interfaces.ECPointEncoder;
import org.sandrob.bouncycastle.jce.provider.asymmetric.ec.EC5Util;
import org.sandrob.bouncycastle.jce.provider.asymmetric.ec.ECUtil;
import org.sandrob.bouncycastle.jce.spec.ECNamedCurveParameterSpec;
import org.sandrob.bouncycastle.jce.spec.ECNamedCurveSpec;
import org.sandrob.bouncycastle.math.ec.ECCurve;

public class JCEECPublicKey
    implements ECPublicKey, org.sandrob.bouncycastle.jce.interfaces.ECPublicKey, ECPointEncoder
{
    private String                  algorithm = "EC";
    private org.sandrob.bouncycastle.math.ec.ECPoint q;
    ...
    public JCEECPublicKey(
        String              algorithm,
        org.sandrob.bouncycastle.jce.spec.ECPublicKeySpec     spec)
    {
        this.algorithm = algorithm;
        this.q = spec.getQ();
        ...
        else
        {
            if (q.getCurve() == null)
            {
                org.sandrob.bouncycastle.jce.spec.ECParameterSpec s = ProviderUtil.getEcImplicitlyCa();
    ...
    public org.sandrob.bouncycastle.math.ec.ECPoint getQ()
    {
        if (ecSpec == null)
        {
            if (q instanceof org.sandrob.bouncycastle.math.ec.ECPoint.Fp)
            {
                return new org.sandrob.bouncycastle.math.ec.ECPoint.Fp(null, q.getX(), q.getY());
            }
            else
            {
                return new org.sandrob.bouncycastle.math.ec.ECPoint.F2m(null, q.getX(), q.getY());
            }
        }
    ...
    public org.sandrob.bouncycastle.math.ec.ECPoint engineGetQ()
    {
        return q;
    }
