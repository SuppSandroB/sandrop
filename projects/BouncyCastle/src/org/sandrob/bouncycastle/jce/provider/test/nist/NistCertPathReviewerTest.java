package org.sandrob.bouncycastle.jce.provider.test.nist;
...
import org.sandrob.bouncycastle.x509.PKIXCertPathReviewer;
    ...
    extends TestCase
{
    ...
    */
    ...
    public void setUp()
    {
        ...
        {
            Security.addProvider(new org.sandrob.bouncycastle.jce.provider.BouncyCastleProvider());
        }
    }
